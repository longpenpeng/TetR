...
public class BufferedRandomAccessFile extends RandomAccessFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        brafReadFile = new BufferedRandomAccessFile("/home/longpengpeng/kbps/test/wholeMapTable");
        readfilelen = brafReadFile.initfilelen;
        brafWriteFile = new BufferedRandomAccessFile("/home/longpengpeng/kbps/test/out01", "rw", 10);
        ...
        java.io.FileInputStream fdin = new java.io.FileInputStream("/home/longpengpeng/kbps/test/wholeMapTable");
        java.io.BufferedInputStream bis = new java.io.BufferedInputStream(fdin, 1024);
        java.io.DataInputStream dis = new java.io.DataInputStream(bis);

        java.io.FileOutputStream fdout = new java.io.FileOutputStream("/home/longpengpeng/kbps/test/out02");
    ...
    try {
		PrintWriter writer = new PrintWriter("/home/longpengpeng/kbps/test/out03");
		BufferedReader in = new BufferedReader(new FileReader("/home/longpengpeng/kbps/test/wholeMapTable"));
		String line = "";
		brafWriteFile = new BufferedRandomAccessFile("/home/longpengpeng/kbps/test/out05", "rw", 10);
		byte[] byts;
		while((line = in.readLine())!=null){
			String[] spt = line.split("\\s");
			byts = spt[0].trim().getBytes();
			brafWriteFile.write(spt[0].getBytes()); 
			System.out.println(brafReadFile.bufstartpos +"  " + brafReadFile.bufendpos);
			brafWriteFile.seek(brafReadFile.bufendpos + 100);
			byts = (spt[2].trim()+"\n").getBytes();
			brafWriteFile.write((spt[2]+"\n").getBytes()); 
			 
			writer.write(line + "\n");
			brafReadFile.flushbuf();
		}
		brafReadFile.clone();
		writer.flush();
		writer.close();
